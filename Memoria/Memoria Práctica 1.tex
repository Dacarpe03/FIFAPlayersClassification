		...
		\label{s-a4-e2}
			...
			\begin{figure}[!h]
				\begin{center}
					...
					\caption{Entrenamiento durante el Experimento w de la Arquitectura 4}	
					\label{tr-a4-e2}
				\end{center}
			\end{figure}
			
			La matriz de confusi\'on, hemos detectado que por primera vez las clases "Intermediate" y "Good" son las que mayor \textit{recall} tienen lo que refuerza nuestra teor\'ia del m\'inimo local.
			\begin{figure}[!h]
				\begin{center}
