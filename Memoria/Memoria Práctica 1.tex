...
%\address{}
	...
	\section{Arquitectura 2: Deep Feed Forward Neural Network}
		...
		\subsection{Experimento 4: Ajustamos el optimizador ADAM}
			...
			Al haber configurado correctamente el optimizador volvemos a conseguir un \textit{accuracy} similar al que hemos estado obteniendo. Observando la figira \ref{tr-a2-e4} vemos qe podr\'iamos seguir entrenando el modelo por m\'as \textit{epochs} antes de llegar al \textit{overfitting}.
			\begin{figure}[!h]
				\begin{center}
			...
			Analizando la matriz de confusi\'on vemos que ahora hemos solucionado el problema del modelo anterior que clasificaba todos los jugadores en la misma clase
			\begin{figure}[!h]
				\begin{center}
